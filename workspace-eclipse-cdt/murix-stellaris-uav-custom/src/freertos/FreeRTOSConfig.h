...
#define configCPU_CLOCK_HZ                  ( ( unsigned long ) 80000000 ) // energia=80000000  texas=50000000
#define configTICK_RATE_HZ                  ( ( portTickType ) 1000 )
#define configMINIMAL_STACK_SIZE            ( ( unsigned short ) (224) )//search in map file for "Uncalled function"
